...
export default function HomePage() {
  const pageDescription =
    "Hello, I'm Farhan Maulana Pangestu, a Front End Developer, and I'm Student Universitas Alma Ata. I'm developer web applications. I have experience with programming languages React, Next.js, Node.js, Laravel, Express.js, and MongoDB. I'm currently looking for a job as a Fullstack Developer.";
  ...
  return (
    <React.Fragment>
      ...
      <NextSeo
        title="Home" // <-- Judul spesifik, akan menjadi "Home | Portfolio"
        description={pageDescription} // <-- Deskripsi spesifik
        openGraph={{
          title: "Home | Farhan Maulana Pangestu Portfolio",
          description: pageDescription,
          // Anda bisa menambahkan gambar khusus untuk halaman ini
          // images: [{ url: 'https://your-website-url.com/home-image.jpg' }]
        }}
      />
      <motion.div
